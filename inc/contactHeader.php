...
<html lang="en">
<head>
    <title>Contact With Me- Md Abdul Kuddus</title>
    <!-- Meta -->
    <meta charset="utf-8">
...
<header class="header">
        <div class="container clearfix"> 
            ...
            <a style="margin-left: 10px" class="btn btn-outline-success float-right" href="index.php" ><i class="fas fa-home"></i> Go HOme</a>
